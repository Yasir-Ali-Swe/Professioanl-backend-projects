                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription className="text-xs text-muted-foreground">
                                Previously actioned or dismissed suggestions
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-2">
                                {suggestions
                                    ...
                                    .map((suggestion) => (
                                        <div key={suggestion._id} className="flex items-center justify-between p-3 rounded-lg border bg-muted/20">
                                            <div>
                                                <p className="text-sm font-medium">{suggestion.productId.name}</p>
                                                <p className="text-xs text-muted-foreground">SKU: {suggestion.productId.sku}</p>
                                            </div>
                                            <div className="flex items-center gap-3">
