...
// Dummy Data - Staff's own invoices
const dummyMyInvoices = {
    data: {
        invoices: [
            {
                _id: 'inv_1',
                ...
                discount: 50.00,
                status: 'paid',
                createdBy: { _id: 'u1', name: 'John Doe', email: 'john@example.com', role: 'staff' },
                voidedBy: null,
            ...
            },
            {
                ...
                status: 'void',
                createdBy: { _id: 'u1', name: 'John Doe', email: 'john@example.com', role: 'staff' },
                voidedBy: { _id: 'u2', name: 'Jane Smith', email: 'jane@example.com', role: 'admin' },
...
const InvoiceDetailDialog = ({ invoice, open, onOpenChange, userRole }) => {
    ...
    // ✅ Staff cannot void invoices - removed void button
    // Only show void button for Admin/Manager
                    ...
                    {invoice.summary && (
                        <div className="grid grid-cols-3 gap-3 pt-3 border-t">
                            <div className="text-center">
                                ...
                                <p className="text-sm font-medium">{invoice.summary.totalProducts}</p>
                            </div>
                            <div className="text-center">
                                <p className="text-xs text-muted-foreground">Total Quantity</p>
                                <p className="text-sm font-medium">{invoice.summary.totalQuantity}</p>
                            </div>
                            <div className="text-center">
                                <p className="text-xs text-muted-foreground">Avg Item Price</p>
                                <p className="text-sm font-medium">${invoice.summary.averageItemPrice.toFixed(2)}</p>
                            </div>
                        </div>
                    )}
    ...
    return (
        <div className="space-y-4 sm:space-y-6 pb-8">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight sm:text-3xl">My Invoices</h1>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:flex-wrap">
                ...
                {(search || status !== 'all' || minTotal || maxTotal || sortBy !== 'createdAt' || order !== 'desc') && (
                    <Button
                        variant="ghost"
                        size="sm"
