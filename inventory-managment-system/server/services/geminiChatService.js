...
For LIST/OVERVIEW queries, use this EXACT format:
...
[Data table - use proper markdown table format with | and ---]
...
- DO NOT use emojis alone. Always include text like "Paid", "Unpaid", "Active", "Inactive" with the emoji.
- Example: 🟢 Paid, 🔴 Unpaid, 🟢 Active, 🔴 Inactive
- Use proper markdown table format with pipes (|) and dashes (---)
- Do NOT use tabs or spaces for alignment - use markdown table syntax

EXAMPLE TABLE:
| Invoice Number | Customer | Subtotal | Total | Status |
| :--- | :--- | ---: | ---: | :--- |
| INV-2026-0008 | abid | 26,350 | 30,292.5 | 🟢 Paid |
...
meaningful patterns, but here's what we have:"`;
        ...
        finalPrompt = `Now provide your final response with this EXACT format:
...
1. For table status, always include text with the emoji: 🟢 Paid, 🔴 Unpaid, 🟢 Active, 🔴 Inactive
2. Use proper markdown table format with pipes (|) and dashes (---)
3. DO NOT use tabs or spaces for alignment - use markdown table syntax
4. DO NOT include both "## 📋" and "## 📊" - use only ONE heading
5. Start with "## 📊 [Topic] Overview"
6. The table should be a proper markdown table with headers and rows

EXAMPLE TABLE FORMAT:
| Invoice Number | Customer | Subtotal | Total | Status |
| :--- | :--- | ---: | ---: | :--- |
| INV-2026-0008 | abid | 26,350 | 30,292.5 | 🟢 Paid |
| INV-2026-0007 | Yasir | 13,050 | 14,997.5 | 🟢 Paid |

EMOJI + TEXT RULES:
- For paid/active/paid invoices: 🟢 Paid
- For unpaid/inactive/void: 🔴 Unpaid
- For low stock: 🟡 Low Stock
- For out of stock: 🔴 Out of Stock
- For dead stock: ⚫ Dead Stock

SECTION INCLUSION RULES:
- 📊 Overview: ALWAYS include for list queries
