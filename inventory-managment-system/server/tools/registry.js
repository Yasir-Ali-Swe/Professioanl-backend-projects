...
//     // Primary intent: list, but individual actions determine subtype
//     intentType: "mixed", // because it has both list_products and product_details
//     actions: {
...
//     intentType: "mixed", // Depends on what the aggregation does
//   },
...
//   // If the tool has action-specific intent mapping
//   if (entry.actions && entry.actions[action]) {
//     return entry.actions[action].intentType;
//   }

//   // Fall back to the tool's default intent
//   return entry.intentType || "mixed";
// };

// /**
//  * Helper to determine if a tool result should be treated as detail
//  */
// export const isDetailIntent = (toolName, action) => {
//   return getIntentType(toolName, action) === "detail";
// };
...
/**
 * Central registry for all Gemini tool declarations and handler mappings.
 * Each tool now includes an `intentType` field for explicit intent classification.
 */
